...
/**
 * Renders the shared Tabs.Tab header elements (Pos. through TOML).
 * Must be placed inside a <Tabs.List>.
 */
export function ProcessingTabHeaders() {
  return (
    <>
...
/**
 * Renders the shared Tabs.Panel elements (positioning through toml) plus
 * SnrMaskModal, SignalSelectModal, and FileBrowserModal.
 * Must be placed as a sibling of Tabs.Panel elements inside a <Tabs>.
 */
export function ProcessingTabPanels({ config, onConfigChange }: ProcessingConfigTabsProps) {
  // Modal state
